                    ...
                    <div className="review-info">
                      ...
                      <div className="review-rate">
                        <ul className="review-star">
                          ...
                          <li className="active"><i className="fa fa-star"></i></li>
                          <li className="active"><i className="fa fa-star"></i></li>
                          <li className=""><i className="far fa-star"></i></li>
                        </ul>
                        (4/5)
                      </div>
                ...
                <div className="col-md-5">
                  <div className="review-form">
                    <form action="product_detail.html" name="review_form" method="POST">
                      ...
                      <div className="mb-3">
                        <label htmlFor="email" className="form-label">Title <span className="text-danger">*</span></label>
                        <input type="text" className="form-control" id="email" />
                      </div>
                      <div className="mb-3">
                        <label htmlFor="review" className="form-label">Review <span className="text-danger">*</span></label>
                        <textarea className="form-control" rows={8} id="review"></textarea>
                      </div>
                      <div className="mb-3">
                        <label htmlFor="email" className="form-label">Rating  <span className="text-danger">*</span></label>
